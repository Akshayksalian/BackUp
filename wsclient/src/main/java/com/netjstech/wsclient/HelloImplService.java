 ...
 * 
 */
@WebServiceClient(name = "HelloImplService", targetNamespace = "http://soapwsDemo.com/", wsdlLocation = "http://localhost:8080/soapws/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOIMPLSERVICE_QNAME = new QName("http://soapwsDemo.com/", "HelloImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/soapws/ws/hello?wsdl");
    ...
    public Hello getHelloImplPort() {
        return super.getPort(new QName("http://soapwsDemo.com/", "HelloImplPort"), Hello.class);
    }
    ...
    public Hello getHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soapwsDemo.com/", "HelloImplPort"), Hello.class, features);
    }
